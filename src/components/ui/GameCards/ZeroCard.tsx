export default function ZeroCard() {
    return (
        <div className="relative flex flex-col items-center justify-center size-full">
            <div
                className="absolute w-full h-1/2 -bottom-1/2 blur-[32px] bg-[#FFD600] -z-20 rounded-full"
            >
            </div>
            <div
                className="absolute w-full h-1/2 -top-1/2 blur-[32px] bg-[#FFD600] -z-20 rounded-full"
            >
            </div>
